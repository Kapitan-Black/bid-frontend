    ...
    <div dir="rtl" className="">
      <Accordion type="single" collapsible>
        <AccordionItem key={data.id} value={data.id} className="group">
          <AccordionTrigger
            className={`flex flex-col sm:flex-row bg-customGreen1 text-sm sm:text-lg text-white font-semibold p-2 sm:p-4 hover:no-underline border-2 hover:border-green-300 ${
